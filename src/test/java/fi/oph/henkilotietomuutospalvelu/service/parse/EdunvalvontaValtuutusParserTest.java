...
public class EdunvalvontaValtuutusParserTest {
    ...
    public void parsesEdunvalvontaValtuutus() {
        ...
        EdunvalvontaValtuutus valtuutus = EdunvalvontaValtuutusParser.parseEdunvalvontaValtuutus(tietoryhma);
    ...
    public void serializesEdunvalvontaValtuutus() {
        String tietoryhma = "31612020102600000000 1 ";
        EdunvalvontaValtuutus valtuutus = EdunvalvontaValtuutusParser.parseEdunvalvontaValtuutus(tietoryhma);
        assertEquals(tietoryhma, EdunvalvontaValtuutusParser.serializeEdunvalvontaValtuutus(valtuutus));
    }
}
