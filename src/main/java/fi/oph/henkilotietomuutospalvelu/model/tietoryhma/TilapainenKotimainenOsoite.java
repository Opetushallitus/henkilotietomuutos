...
@Setter
@NoArgsConstructor
public class TilapainenKotimainenOsoite extends YhteystietoTietoryhma {
    ...
    @Builder
    public TilapainenKotimainenOsoite(Ryhmatunnus ryhmatunnus, Muutostapa muutostapa, String lahiosoite, String lahiosoiteSV,
